...
<p class="nivel2">
    4.1 Para acessar os Serviços, poderá ser solicitado ao usuário que forneça informações pessoais (tais como usuário e senha, por exemplo) como parte do processo de registro para o Serviço ou como parte da utilização continuada dos Serviços por parte do usuário. O usuário concorda que as informações de registro que fornecer ao Portal serão sempre exatas, corretas e atualizadas.
<br/><br/>
...
<br/><br/>
    5.3 Se tomar conhecimento de qualquer utilização não autorizada da sua senha ou da sua conta, o usuário concorda em notificar imediatamente o Portal no canal de Contato da aplicação.
</p>
<p class="nivel1">
...
<br/><br/>
    10.2 Se o usuário quiser encerrar o seu contrato com o Portal, pode fazê-lo (a) notificando o Portal a qualquer momento e (b) encerrando as contas relativas a todos os Serviços que utiliza, no caso de essa opção ser disponibilizada pelo Portal.
<br/><br/>
...
<br/><br/>
        (B) tal for exigido ao Portal por lei (por exemplo, quando o fornecimento dos Serviços ao usuário for ou se tornar ilegal).
</p>
<p class="nivel1">
11. Anúncios
</p>
