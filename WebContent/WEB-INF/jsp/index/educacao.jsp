...
<div align="center">
	...
	<li><img src="${imagem}/educacao_foto1.jpg" alt="" title="" id="wows1_0"/></li>
	<li><img src="${imagem}/educacao_foto2.jpg" alt="" title="" id="wows1_1"/></li>
	<li><img src="${imagem}/educacao_foto3.jpg" alt="" title="" id="wows1_2"/></li>
	</ul>
	</div>
	</div>

	<%-- <ul id="carouselEducacao">
		<li><img src="${imagem}/educacao_foto1.jpg"></li>
		<li><img src="${imagem}/educacao_foto2.jpg"></li>
		<li><img src="${imagem}/educacao_foto3.jpg"></li>
	</ul>	 --%>
